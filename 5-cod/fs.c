...
void find(char* tip_cautare, char* nume_fisier)
{
    if(strcmp(tip_cautare, "~")==0)
    {
            ...
            if(strcmp(Inodes[i].name, nume_fisier)==0)
                {
                    ...
                    if (verificare[0] == '4' && verificare[1] == '0')
                    {
                        printf("a fost gasit un director cu numele cautat\n");
                    }
                    else
                    {
                        index_fisier = i;
        ...
        if(index_fisier==-1)
            printf("Fisierul cautat nu exista");
...
void main()
{
        ...
        switch(command_type)
    {
        ...
        case CD:
            ...
            break;
        case COMANDA_INCORECTA:
            printf("Comnda incorecta, incercati din nou\n");
            break;
        case MKDIR:
